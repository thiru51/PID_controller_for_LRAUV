...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'open_loop_controller = altitude_controller.open_loop_controller:main',
            'lrauv_xy_altitude_mission= altitude_controller.lrauv_xy_altitude_mission:main',
            'lrauv_altitude_debugger = altitude_controller.lrauv_altitude_debugger:main',
        ],
    },
)
